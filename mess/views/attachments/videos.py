...
from mess.models.attachments import Videos
from mess.serializers.attachments import VideosSerializer


class VideosList(LoggingMixin, generics.GenericAPIView):
...
class VideoDetail(LoggingMixin, generics.GenericAPIView):
    serializer_class = VideosSerializer
    permission_classes = (permissions.IsAuthenticated, permissions.IsAdminUser,)
